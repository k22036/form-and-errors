...
const failLinks: FailLink[] = [
  {
    href: "/form/fail?redirect=true",
    label: "リダイレクトあり",
    description: "/form/fail?redirect=true",
  },
  {
    href: "/form/fail?redirect=false",
    label: "リダイレクトなし",
    description: "/form/fail?redirect=false",
  },
];

const FormFailList: React.FC = () => (
